...
public class MapService {
	...
	public void ex2() {
		// Map 사용 예제
		// VO(Value Object) 값 저장용 객체는 특정 데이터 묶음이 재사용이 많은 경우 주로 사용
		...
		// String java.lang.Object.toString() ==> 정적 바인딩 상태
		...
		// --> 이를 활용할 수 있도록 Map에서 keySet() 메서드 제출
		// --> key만 모아서 Set으로 반환
	...
	public void ex3() {
		// List + Map
		// user 10명, user의 id만 리스트로 쭉 뽑고싶다
		...
		// for문 종료 시점에 List에는 10개의 Map객체가 추가 되어 있다.
