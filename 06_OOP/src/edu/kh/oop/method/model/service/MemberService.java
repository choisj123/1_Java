...
public class MemberService { //클래스
	...
	//기능(생성자,매서드) 
	// **여러 기능을 하나의 메서드에 모두 작성하지 말 것!
	//	되도록 하나의 기능만 수행하도록 작성
	//	매소드는 매소드당 딱 하나의 기능만 가지고 있는게 좋다
	//왜?
	...
	//매개변수이용한 생성자만 작성하면, 기본 생성자 미작성시 에러
	...
	public void displayMenu() {
		...
		do {
			...
			case 4 : 
				...
				int result = updateMemeber(); //-1 or 1 or 0
	...
	public int updateMemeber() {
		...
		// sc.next(), sc.nextInt(), sc.nextDouble() 다음에
		// sc.nextLine();
		sc.nextLine();
		// 입력 버퍼 정리하기 
