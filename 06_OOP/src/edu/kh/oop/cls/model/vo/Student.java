...
public /*[예약어] */class Student { // 클래스 선언부
...
// 접근제한자 public : 같은 프로젝트 내에서 어떤 클래스에서든 import 할 수 있음을 나타냄
	...
	//		2) 클래스 변수(static 변수): 필드에 static 예약어가 작성된 변수 (객체 생성 안해도 사용 가눙)
...
클래스 다이어그램(명세서)에만 있음 
	...
	private String name; //캡슐화 원칙 private --> 간접접근방법이 필요함
