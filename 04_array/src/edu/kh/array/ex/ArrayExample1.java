...
public class ArrayExample1 {
	...
	public void ex1() {
		...
		// new int[3] : Heap(힙)영역에 int 3칸짜리 int[]을 생성(할당)
	...
	public void ex5() {
		...
		System.out.println(Arrays.toString(arr2)); //int 기본값 = 0
	...
	public void ex8() {
		// 1. 믄자열을 입력 받아 한 글자씩 잘라내어 char 배열에 순서대로 저장
		...
		// 	  ex) "Hello".length() -> 4
		// 3) String.charAt(index) : 문자열에서 특정 index에 위치한 문자 하나를 엍어옴
		// 	  ex) "Hello".charAt(1) -> 'e'
		// 	       01234
		// 4) count 숫자 세기
		// 문자열 입력:
